...
const LEAGUES = [
  { 
    ...
    url: 'https://northerncricketunion.org/ncu-nv-play-match-zone/?tab=c_stats#c42955698-0385-447f-8070-185a03b349bb',
    teamName: 'Arches 1st XI',
    prefix: 't1'
  },
  { 
    name: 'Junior League 10', 
    url: 'https://northerncricketunion.org/ncu-nv-play-match-zone/?tab=c_stats#cd848fff8-615c-4dd3-a3b5-185cefd17fa0',
    teamName: 'Arches 2nd XI',
    prefix: 't2'
  },
  { 
    name: 'Midweek League Group B', 
    url: 'https://northerncricketunion.org/ncu-nv-play-match-zone/?tab=c_stats#cea759f09-8663-4fe0-9c79-9c653aeca391',
    teamName: 'Arches Midweek XI',
    prefix: 'mw'
  },
  {
    name: 'NCU Junior Cup',
    url: 'https://northerncricketunion.org/ncu-nv-play-match-zone/?tab=c_stats#c4af1fda1-3d40-408b-bfaa-aa14fd0b658b',
    teamName: 'Arches 1st XI',
    prefix: 'cup'
  },
  {
    name: 'Development Cup',
    url: 'https://northerncricketunion.org/ncu-nv-play-match-zone/?tab=c_stats#ca060450b-a00d-41c1-9c06-85f6b717b248',
    teamName: 'Arches 2nd XI',
    prefix: 'cup'
  },
  {
    name: 'Lagan Valley Steels T20 Shield',
    url: 'https://northerncricketunion.org/ncu-nv-play-match-zone/?tab=c_stats#c60d44c69-295b-4c45-b6a5-0a2bcb811762',
    teamName: 'Arches 1st XI',
    prefix: 'cup'
  }
];
...
(async () => {
  ...
  try {
    ...
    // Save
    const outPath1 = path.join(__dirname, '../data/players_2025.json');
    const outPath2 = path.join(__dirname, '../public/data/players_2025.json');
    ...
    console.log('\n===================================');
    console.log('Saved scraped player stats successfully to data/players_2025.json and public/data/players_2025.json!');
